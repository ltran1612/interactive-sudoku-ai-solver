...
There will be a Sudoku model and solver built using Cling (Answer Set Programming) and Python.
Then we will use a ReAct agent through `dspy` to use the tools exposed by this model to solve a problem through prompts.
